...
from functions import LeadingShape, Kernel, KernelQuadratic, KernelLyapunovQuad, KernelBarrier, KernelFamily
...
# clf = KernelLyapunovQuad(kernel=kernel, P=load_compatible(__file__, Pquadratic, load_compatible=True), limits=limits)
# clf = KernelLyapunov(kernel=kernel, P=Pquadratic, limits=limits)
clf = KernelLyapunovQuad(kernel=kernel, leading=LeadingShape(Pquadratic,bound='lower',approximate=True), limits=limits)
